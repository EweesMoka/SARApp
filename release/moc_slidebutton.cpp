/****************************************************************************
** Meta object code from reading C++ file 'slidebutton.h'
**
...
#error "The header file 'slidebutton.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 29, 9) // "onTimeout"

    },
    "SlideButton\0toggled\0\0checked\0onTimeout"
};
...
void SlideButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SlideButton::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SlideButton::toggled)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SlideButton::toggled(bool _t1)
{
