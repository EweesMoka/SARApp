...
bool SlideButton::isToggled() const
{
    return m_bChecked;
}

// 设置开关状态
void SlideButton::setToggle(bool checked)
{
    m_bChecked = checked;
    m_timer.start(10);
}
...
// 设置背景颜色
void SlideButton::setBackgroundColor(QColor color)
{
    m_background = color;
}

// 设置选中颜色
void SlideButton::setCheckedColor(QColor color)
{
    m_checkedColor = color;
}

// 设置不可用颜色
void SlideButton::setDisbaledColor(QColor color)
{
